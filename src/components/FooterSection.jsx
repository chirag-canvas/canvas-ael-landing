        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-4 mb-16">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="space-y-3 mb-8">
              ...
              <a href="#" className="block text-gray-400 hover:text-white transition-colors">Watch Demo</a>
            </div>
          ...
          <div className="flex flex-col items-start md:items-end">
            <h3 className="text-2xl font-bold mb-4">Canvas Space Inc.</h3>
            
            <p className="text-gray-400 mb-2 md:text-right">5548, Abington Drive, Newark,<br/>California, 94560</p>
            
            <a href="mailto:hello@canvas.space" className="text-gray-400 hover:text-white mb-6">hello@canvas.space</a>
            ...
            <div className="gradient-border-container relative">
              <button 
                className="px-8 py-3 rounded-full font-medium bg-transparent relative"
              >
                <span 
                  style={{
                    background: gradient,
