        ...
        <div className="max-w-6xl mx-auto flex flex-col md:grid md:grid-cols-2 gap-10 md:gap-4 mb-12">
          ...
          <div className={`flex flex-col ${isMobile ? 'items-center justify-center text-center mt-8' : 'items-start md:items-end'}`}>
            ...
            <div className={`flex space-x-4 mb-8 ${isMobile ? 'justify-center' : ''}`}>
              <a href="https://x.com/CanvasSpace/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 transition-colors">
              ...
              <a href="https://www.linkedin.com/company/canvas-space/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
